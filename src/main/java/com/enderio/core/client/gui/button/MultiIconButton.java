...
public class MultiIconButton extends IconButton {
  ...
  public static @Nonnull MultiIconButton createRightArrowButton(@Nonnull IGuiScreen gui, int x, int y) {
    return new MultiIconButton(gui, x, y, EnderWidget.RIGHT_ARROW, EnderWidget.RIGHT_ARROW_PRESSED, EnderWidget.RIGHT_ARROW_HOVER);
  }

  public static @Nonnull MultiIconButton createLeftArrowButton(@Nonnull IGuiScreen gui, int x, int y) {
    return new MultiIconButton(gui, x, y, EnderWidget.LEFT_ARROW, EnderWidget.LEFT_ARROW_PRESSED, EnderWidget.LEFT_ARROW_HOVER);
  }

  public static @Nonnull MultiIconButton createAddButton(@Nonnull IGuiScreen gui, int x, int y) {
    return new MultiIconButton(gui, x, y, EnderWidget.ADD_BUT, EnderWidget.ADD_BUT_PRESSED, EnderWidget.ADD_BUT_HOVER);
  }

  public static @Nonnull MultiIconButton createMinusButton(@Nonnull IGuiScreen gui, int x, int y) {
