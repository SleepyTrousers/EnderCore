...
//  private static float getNightVisionBrightness(@Nonnull LivingEntity entitylivingbaseIn, float partialTicks) {
//    int i = NullHelper.notnull(entitylivingbaseIn.getActivePotionEffect(Potions.NIGHT_VISION), "LOC9003476").getDuration();
...
//      }
//
//      RenderType.setFog(GlStateManager.FogMode.EXP);
//
//
...
//
//      if (entity instanceof LivingEntity) {
//        f12 = EnchantmentHelper.getRespirationModifier((LivingEntity) entity) * 0.2F;
//
//        if (((LivingEntity) entity).isPotionActive(MobEffects.WATER_BREATHING)) {
//          f12 = f12 * 0.3F + 0.6F;
//        }
...
//      fogColorGreen *= f13;
//      fogColorBlue *= f13;
//      double d1 = (entity.lastTickPosY + (entity.getPosY() - entity.lastTickPosY) * partialTicks) * world.provider.getVoidFogYFactor();
//
//      if (entity instanceof LivingEntity && ((LivingEntity) entity).isPotionActive(MobEffects.BLINDNESS)) {
//        int i = NullHelper.notnull(((LivingEntity) entity).getActivePotionEffect(MobEffects.BLINDNESS), "LOC9903481").getDuration();
//
//        if (i < 20) {
//          d1 *= 1.0F - i / 20.0F;
//        } else {
...
//        float f15 = getNightVisionBrightness((LivingEntity) entity, partialTicks);
