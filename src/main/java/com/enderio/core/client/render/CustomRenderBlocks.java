...
public class CustomRenderBlocks extends RenderBlocks {
    ...
    private void renderFace(ForgeDirection face, Block par1Block, double x, double y, double z, IIcon texture) {
        if (renderFaceCallbacks.isEmpty()) {
            ...
            List<Vertex> faceVertices = createVerticesForFace(
                    face,
                    par1Block,
                    x,
                    y,
                    z,
                    overrideTexture == null ? texture : overrideTexture);
    ...
    public List<Vertex> createVerticesForFace(ForgeDirection face, Block par1Block, double x, double y, double z,
            IIcon icon) {
        switch (face) {
            case DOWN:
    ...
    public void doDefaultRenderFace(ForgeDirection face, Block par1Block, double par2, double par4, double par6,
            IIcon par8Icon) {
        switch (face) {
            case DOWN:
