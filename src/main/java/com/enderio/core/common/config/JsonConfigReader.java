 ...
 * 
 * @param <T> The type of the object to be read in. If this type is generic in itself (ex. {@code HashMap}) you should
...
public class JsonConfigReader<T> implements Iterable<T> {
     ...
     * 
     * @param mod          A {@link ModToken} object to hold data about your mod. This is used to automatically copy the
     *                     file from your jar if it does not exist in the config folder
     * @param fullFileName The full file path and name of your JSON config. Can be relative to the working directory or
     *                     absolute.
     * @param objClass     The type of the object being deserialized. Must be of the same type as the generic type of
     *                     this class.
     */
     ...
     * @param objClass The type of the object being deserialized. Must be of the same type as the generic type of this
     *                 class.
     */
     ...
     * @param fullFileName The full file path and name of your JSON config. Can be relative to the working directory or
     *                     absolute.
     * @param objType      A {@link TypeToken} representing the type of the object to be deserialized. Must be of the
     ...
     * itself. (ex. {@code HashMap<K, V>})
     * 
     * @param mod     A {@link ModToken} object to hold data about your mod. This is used to automatically copy the file
     *                from your jar if it does not exist in the config folder
     * @param file    The {@link File} representing your JSON config.
     * @param objType A {@link TypeToken} representing the type of the object to be deserialized. Must be of the same
