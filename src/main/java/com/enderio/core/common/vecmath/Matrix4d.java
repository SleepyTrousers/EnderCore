...
public class Matrix4d {
    ...
    public double determinant() {
        double result = m00 * ((m11 * m22 * m33 + m21 * m32 * m13 + m31 * m12 * m23) - m31 * m22 * m13
                - m11 * m32 * m23
                - m21 * m12 * m33);
        result -= m10 * ((m01 * m22 * m33 + m21 * m32 * m03 + m31 * m02 * m23) - m31 * m22 * m03
                - m01 * m32 * m23
                - m21 * m02 * m33);
        result += m20 * ((m01 * m12 * m33 + m11 * m32 * m03 + m31 * m02 * m13) - m31 * m12 * m03
                - m01 * m32 * m13
                - m11 * m02 * m33);
        result -= m30 * ((m01 * m12 * m23 + m11 * m22 * m03 + m21 * m02 * m13) - m21 * m12 * m03
                - m01 * m22 * m13
                - m11 * m02 * m23);
        return result;
    }

    private double determinant3x3(double e00, double e01, double e02, double e10, double e11, double e12, double e20,
