...
public interface ITankAccess {
     ...
     * 
     * @param forFluidType The type of fluid that should be inserted. May be null.
     * @return An internal tank that can take the given type of fluid. If multiple tanks can take the fluid, the first
     *         one that is not full will be returned. If no tank can take the fluid, returns null.
     */
